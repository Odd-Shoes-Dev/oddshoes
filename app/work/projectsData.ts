...
export const projects: Project[] = [
  ...
  },
  {
    ...
    category: 'web',
    url: 'https://davincianalytics.co.ke',
  ...
  },
  {
    ...
    category: 'web',
    url: 'https://devfestqa.com',
    gradient: 'linear-gradient(135deg, #e0c3fc 0%, #8ec5fc 100%)',
    subtitle: 'Real-time Q&A for tech conferences and events',
    logoPath: '/images/devfest/1.png',
    logoStyle: 'light',
    logoText: 'DevFest Q&A',
    logoBackgroundColor: '#f5f5f5',
    screenshotCount: 1,
    imageFolder: 'devfest',
    overview: 'DevFest Q&A is a live question and answer platform built for conferences and large events, allowing attendees to submit and upvote questions in real-time.',
    challenge: 'Event organizers struggled to manage audience questions during sessions, with microphone queues being slow and many questions going unheard.',
    solution: 'We created a web app where attendees submit questions via their phones, and the community upvotes the best ones, ensuring speakers address what the audience really wants to know.',
    techStack: ['Next.js', 'Socket.io', 'MongoDB', 'Redis', 'Real-time sync'],
    features: [
      'Real-time question submission',
      'Community upvoting system',
      'Moderator dashboard for filtering',
      'Multi-session support',
      'Speaker view with top questions',
  ...
  },
  {
    ...
    logoBackgroundColor: '#000000',
    screenshotCount: 2,
    overview: 'Workflowe is a mobile-first project management app designed for small teams who need task tracking without the complexity of enterprise tools.',
    challenge: 'Existing project management tools are too complex for small teams and lack good mobile experiences for field workers and remote teams.',
    solution: 'We created a streamlined mobile app focused on the essentials: tasks, deadlines, team communication, and progress tracking with an intuitive interface.',
    techStack: ['React Native', 'Firebase', 'Node.js', 'MongoDB', 'Push Notifications'],
    features: [
