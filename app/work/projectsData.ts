...
export const projects: Project[] = [
  ...
  },
  {
    ...
    gradient: 'linear-gradient(135deg, #a8edea 0%, #fed6e3 100%)',
    subtitle: 'All-in-one school administration and learning management',
    logoPath: '/images/bythefruit/logo.png',
    logoStyle: 'light',
    logoText: 'By The Fruit',
    logoBackgroundColor: '#2d5016',
    screenshotCount: 2,
    ...
    gradient: 'linear-gradient(135deg, #a8edea 0%, #fed6e3 100%)',
    subtitle: 'All-in-one school administration and learning management',
    logoPath: '/images/blueoxkampus/logo.png',
    logoStyle: 'light',
    logoText: 'Blue Ox Kampus',
    logoBackgroundColor: '#2d5016',
    screenshotCount: 2,
    imageFolder: 'blueoxkampus',
  ...
  },
  {
    ...
    gradient: 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)',
    subtitle: 'Deploy AI assistants to any channel in seconds',
    logoPath: '/images/openclaw/1.png',
    logoStyle: 'light',
    logoText: 'Openclaw',
    logoBackgroundColor: '#000000',
    screenshotCount: 1,
  ...
  },
   {
    ...
    gradient: 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)',
    subtitle: 'Bible study and discussion platform',
    logoPath: '/images/biblebanter/1.png',
    logoStyle: 'light',
    logoText: 'Bible Banter',
    logoBackgroundColor: '#000000',
    screenshotCount: 2,
    imageFolder: 'biblebanter',
    overview: 'Open-Clawbot is an AI assistant deployment platform that allows businesses to quickly deploy conversational AI bots across multiple messaging channels including Telegram, Discord, and WhatsApp.',
    challenge: 'Businesses struggle to deploy and manage AI assistants across multiple messaging platforms, requiring separate integrations and technical expertise for each channel.',
    solution: 'We built a unified platform that enables one-click deployment of AI assistants to multiple messaging channels, with seamless integration and centralized management.',
    techStack: ['Next.js', 'Python', 'OpenAI API', 'Telegram Bot API', 'Discord API', 'WhatsApp API'],
   ...
   ,
   {
    ...
    url: 'https://bible-banter.vercel.app',
    gradient: 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)',
    subtitle: 'Interactive Bible study challenges',
    logoPath: '/images/biblebanter/1.png',
    logoStyle: 'light',
    logoText: 'Bible Battle',
    logoBackgroundColor: '#000000',
    screenshotCount: 2,
    imageFolder: 'biblebanter',
    overview: 'Open-Clawbot is an AI assistant deployment platform that allows businesses to quickly deploy conversational AI bots across multiple messaging channels including Telegram, Discord, and WhatsApp.',
  ...
  },
   {
    ...
    gradient: 'linear-gradient(135deg, #f093fb 0%, #f5576c 100%)',
    subtitle: 'Faith-based conversation game for Christian couples',
    logoPath: '/images/heartstrings/1.png',
    logoStyle: 'light',
    logoText: 'Heart Strings',
    logoBackgroundColor: '#764ba2',
    screenshotCount: 2,
    imageFolder: 'heartstrings',
    ...
    solution: 'We built an interactive mobile game that sparks meaningful, faith-centered conversations between couples through daily prompts, scripture-based questions, and fun challenges designed to strengthen both their relationship and their walk with God.',
    techStack: ['React Native', 'Python', 'Firebase'],
    features: [
   ...
   //   gradient: 'linear-gradient(135deg, #fbc2eb 0%, #a6c1ee 100%)',
   //   subtitle: 'Plan your perfect wedding, stress-free',
   //   logoPath: '/images/heartstrings/1.png',
   //   logoStyle: 'light',
   //   logoText: 'Vowley',
   //   logoBackgroundColor: '#a6c1ee',
   //   screenshotCount: 0,
   //   overview: 'Vowley takes the chaos out of wedding planning. From guest lists to vendor coordination, budgets to timelines — everything in one place so couples can focus on what matters most.',
   //   challenge: 'Planning a wedding is overwhelming. Couples juggle spreadsheets, WhatsApp groups, scattered vendor contacts, and endless to-do lists — often leading to stress, overspending, and missed details.',
   //   solution: 'We built an all-in-one wedding planning app that organizes every detail — guest management, vendor coordination, budget tracking, and timeline planning — so couples can enjoy the journey, not just survive it.',
   ...
   //     'Shared access for couples and planners',
   //   ]
   // }
];
